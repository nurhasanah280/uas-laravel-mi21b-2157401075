...
<body class="bg-gradient"> <!-- Mengubah class bg-orange menjadi bg-gradient -->
    <div class="container">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <h2 class="card-title">Login</h2> <!-- Menghapus kelas text-center -->
                        <form action="/postlogin" method="POST"> <!-- Mengubah action -->
                            ...
                            <button type="submit" class="btn btn-green btn-block">Login</button> <!-- Menggunakan kelas btn-green -->
                            <a href="/halamanawal" class="btn btn-green btn-block">kembali</a> <!-- Menggunakan kelas btn-green -->
                        </form>
                    </div>
                </div>
            </div>
